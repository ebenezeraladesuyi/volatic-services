...
const Contact = () => {
  return (
    ...
    <div  className="font-extrabold text-[50px]  text-center text-white">
      Start a Conversation With Us Today 
    </div>
    <h1 className="font-light text-[15px] text-white text-center">Let’s bring your idea to life</h1>
    <h1 className=" text-[20px] text-white text-center py-6"> From project ideas and vision to
    ...
    <h1 className=" pt-7 px-10 font-extrabold text-4xl text-center">
      Contact Us
    </h1>
    <h1 className="text-[15px]  pt-4 px-10 text-center"> Your information is securely handled to enable us contact you <br/>
        and discuss your project in detail. </h1>

        <h1 className="px-10 pt-4 flex justify-center items-center gap-1.5"> <span className="text-3xl text-blue-900
        ...
        <h1 className="px-10 pt-4 flex justify-center items-center gap-1.5"> <span className="text-3xl
        ...
        bg-blue-200 rounded-[7px] w-8 h-8 hover:animate-bounce">
         ...
         <div className="mx-10 my-20  w-150 min-h-100 border-2 border-gray-400 rounded-2xl
          shadow-gray-500 shadow-2xl bg-[#6096bf]">
            <div>
            <h1 className="mx-8 mt-10 text-[18px] font-medium text-white"> First name:  </h1>
            <input className="border 
             border-gray-300 mx-8 px-4 mt-2 rounded-[7px] w-130 h-10 placeholder:text-[#c4c9dc] 
             ...
             border-gray-300 mx-8 mt-2 rounded-[7px] w-130 h-10 placeholder:text-[#BDCAE6] 
             ...
             placeholder:text-[15px]" type="string" placeholder="+234 000 000 0000"/>
              ...
              <input className="border border-gray-300 mx-8 mt-2 rounded-[7px] w-130 h-30 px-4
